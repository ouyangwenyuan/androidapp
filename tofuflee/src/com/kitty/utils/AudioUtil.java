...
public class AudioUtil {
	...
	// 声音资源ID
	private static final int[] soundIds = { R.raw.hijump, R.raw.crumble,
			R.raw.pickup, R.raw.lose, R.raw.fanfare };
	// 上下文环境
	...
	private void initSounds() {
		...
		soundPool = new SoundPool(soundIds.length, AudioManager.STREAM_MUSIC,
				100);
		// 初始化ＨＡＳＨ表
	...
	public void play(int id, int loop) {
		soundPool.play(soundPoolMap.get(id), streamVolume, streamVolume, 1,
				loop, 1f);
	}
	...
	public void dokeyDown(int keyCode) {
		...
		case KeyEvent.KEYCODE_VOLUME_UP:
			mgr.adjustStreamVolume(AudioManager.STREAM_MUSIC,
					AudioManager.STREAM_RING, AudioManager.FLAG_SHOW_UI);
			break;
